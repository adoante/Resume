...
\section{Technical Skills}
    ...
    [leftmargin=0.15in, label={}]\small{\item{
        % LANGUAGES
        \textbf{Languages}{: C, C++, Java, Python, HTML/CSS, JavaScript, C#, Cobol, Fortran, LaTeX} \\
        % TOOLS
...
\section{Projects} 
    \resumeSubHeadingListStart
        ...
        {Spring 2024}
        \resumeItemListStart
            \resumeItem{Utilized LaTeX and MiKTeX compiler to create Harvard styled resume.}
