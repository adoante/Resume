...
\section{Technical Skills}
    ...
    [leftmargin=0.15in, label={}]\small{\item{
        % LANGUAGES
        \textbf{Languages}{: C, C++, Java/Scala/Clojure/Kotlin, Python, HTML/CSS, JavaScript, C\#, LaTeX, Cobol, Fortran, Rust} \\
        % TOOLS
        \textbf{Developer Tools}{: Git/GitHub, VSCode, Vim, Visual Studio, Command Line, Unity} \\
        % TECHNOLOGIES
...
\section{Projects} 
    \resumeSubHeadingListStart
        ...
        {Spring 2024}
        \resumeItemListStart
            \resumeItem{Utilized LaTeX and MiKTeX compiler to create clean Harvard styled resume.}
        ...
        {Spring 2024}
        \resumeItemListStart
            \resumeItem{Developed in the Unity Game Engine and used C\# scripts to implement game logic.}
