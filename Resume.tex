...
\section{Education}
  \resumeSubHeadingListStart
    ...
    {Bachelors of Science in Computer Science, }{2023 - Anticipated Graduation 06/25}
    \resumeSubheading
...
\section{Selected Coursework}
        % BULLET POINTS
        \resumeItemListStart
            \resumeItem{Data Structures \& Algorithms, Computer Architecture, Operating Systems}
            \resumeItem{Linux Fundamentals, Machine Organization \& Assembly Language}
            \resumeItem{Calculus I \& II, Linear Algebra}
        \resumeItemListEnd
%%%%%%%%%%%%%%%%%%%%%%%%%%%%  PROJECTS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Personal Projects} 
    \resumeSubHeadingListStart
        ...
        {Summer 2023}
        \resumeItemListStart
            \resumeItem{Embedded Systems project utilizing a Raspberry Pi Pico Mircocontroller, Circuit-Python and 3D-printed case.}
        \resumeItemListEnd
        % Project 2
        \resumeProjectHeading
        {catpictures.xyz}
        ...
        {Fall 2023}
        \resumeItemListStart
            \resumeItem{Web Development project utilizing multiple APIs. TheCatAPI fetches random images on page reload. Advice Slip JSON API fetches random advice slip on reload to caption images. Site was build using HTML/CSS and JavaScript.}
        \resumeItemListEnd
